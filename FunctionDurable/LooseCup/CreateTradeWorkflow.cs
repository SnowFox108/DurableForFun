...
namespace FunctionDurable.LooseCup
{
    public static class CreateTradeWorkflow
    {
            ...
            )
        {
            ...
            log.LogWarning("about to call Step1 Orchestrator");
            ...
            log.LogWarning("about to call Step2 Orchestrator");
            ...
            log.LogWarning("about to call Step3 Activity");
            ...
            try
            {
                tradeProcess.FenicId = await context.WaitForExternalEvent<int>("FenicsTaskComplete");
